    ...
    items(): Item[] {
      return [
        ...
        },
        {
          ...
          link: 'https://www.pref.chiba.lg.jp/shippei/covid19-vaccine.html',
          divider: true
        },
        {
          icon: 'mdi-phone',
        ...
        {
          icon: 'ParentIcon',
          title: this.$t('千葉県教育委員会'),
          link: 'https://www.pref.chiba.lg.jp/kyouiku/anzen/hokenn/covid-19.html'
        },
        {
          icon: 'mdi-domain',
          title: this.$t('中小企業者支援について'),
          link: 'https://www.pref.chiba.lg.jp/keishi/ncov/ncov-index.html'
        },
        {
          icon: 'mdi-food-apple',
          title: this.$t('農林漁業者向けの支援'),
        ...
        },
        {
          ...
          link:
            'https://www.pref.chiba.lg.jp/jika/boshi/ninpupcr/index.html',
          divider: true
        },
        {
