      ...
      <ul :class="$style.group">
        <li :class="[$style.box, $style.parent]">
          <div :class="$style.content">
            <span>{{ $t('療養中患者数') }}</span>
            <span>
              <strong>{{ 療養中患者数.toLocaleString() }}</strong>
              <span :class="$style.unit">{{ $t('人') }}</span>
            </span>
          </div>
          <ul :class="$style.group">
            <li :class="[$style.box]">
              <div :class="$style.content">
                <span>{{ $t('入院中') }}</span>
                <span>
                  <strong>{{ 入院中.toLocaleString() }}（{{ $t('重症') }}:{{ 重症.toLocaleString() }}） </strong>
                  <span :class="$style.unit">{{ $t('人') }}</span>
                </span>
              </div>
            </li>
            ...
            <li :class="[$style.box]">
              <div :class="$style.content">
                <span>{{ $t('施設内療養') }}</span>
                <span>
                  <strong>{{ 施設内療養.toLocaleString() }}</strong>
                  <span :class="$style.unit">{{ $t('人') }}</span>
                </span>
              </div>
            </li>
        ...
        <li :class="[$style.box]">
          <div :class="$style.content">
            <span>{{ $t('療養解除') }}</span>
            <span>
              <strong>{{ 療養解除.toLocaleString() }}</strong>
              <span :class="$style.unit">{{ $t('人') }}</span>
            </span>
          </div>
        </li>
