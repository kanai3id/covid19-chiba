  ...
  head() {
    ...
    const mInfo: MetaInfo = {
      ...
      link: [
        {
          rel: 'canonical',
          href: `https://covid19-chiba.netlify.app${this.$route.path}`,
        },
        ...(linksAlternate as []),
      ],
      // Disable prettier for readability purposes
      // eslint-disable-next-line prettier/prettier
      titleTemplate: `%s | ${this.$t('千葉県')} ${this.$t('新型コロナウイルス感染症')}${this.$t('対策サイト(非公式)')}`,
      meta: [
        {
          hid: 'author',
          name: 'author',
        ...
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: `https://covid19-chiba.netlify.app${this.$route.path}`,
        },
        ogLocale,
        {
          hid: 'og:title',
